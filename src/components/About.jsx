          ...
          >
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginBottom: '2rem' }}>
              {[
                ...
                "Currently pursuing my B.Tech in Computer Science Engineering (AI & ML) from AKTU, I'm always expanding my skills. When I'm not coding, I'm exploring new technologies, contributing to open-source projects, and participating in hackathons.",
              ].map((para, i) => (
                <motion.p
                  key={i}
